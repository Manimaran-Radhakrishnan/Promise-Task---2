async function data() {
  try {
    ...
    for (var i = 0; i < 12; i++) {
      ...
      p1.innerText = `NAME : ${jso.data[i].artist_titles[0]}`;
      var p2 = document.createElement("p");
      p2.innerText = `ARTIST-ID : ${jso.data[i].artist_ids[0]}`;
      var p3 = document.createElement("p");
      p3.innerText = `DEPARTMENT-NAME : ${jso.data[i].category_titles[0]}`;
      var p4 = document.createElement("p");
      p4.innerText = `DEPARTMENT-ID : ${jso.data[i].category_ids[0]}`;
      var p5 = document.createElement("p");
      p5.innerText = `MATERIAL NAME : ${jso.data[i].material_titles[0]}`;
      var p6 = document.createElement("p");
      p6.innerText = `MATERIAL-ID : ${jso.data[i].material_ids[0]}`;
